...
<div class="menu_ouvert">
    ...
    <div class="container">
        <div class="content_article">
            <h3 class="titre_progression">Progression</h3>
            <ul class="progression">
<?php 
    $nb_videos = wp_count_posts('post')->publish;
    $nb = 0;
    while ($nb < $nb_videos){
        echo '<li class="item_pro"></li>';
        $nb = $nb + 1;
    }
    echo '</ul>';
...
;?>
                <div class="video_principale">
                    ...
                    <div class="texte_video">
                        ...
                        foreach($key_1_value as $lien){
                            $lien_facebook = "https://www.facebook.com/dialog/share?app_id=87741124305&href=https%3A//www.youtube.com/watch%3Fv%3D".$lien."";
                            ...
                            echo '"><img src="wp-content/themes/SCB/images/partage_facebook.png"></div>';
                            echo '<div onclick="window.open(';
                            ...
                            echo '"><img src="wp-content/themes/SCB/images/partage_twitter.png"></div>';
                            echo '<div onclick="window.open(';
                            echo "'".$lien_google."', 'nom_interne_de_la_fenetre', config='height=700, width=700, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no')";
                            echo '"><img src="wp-content/themes/SCB/images/partage_google.png"></div>';
                        };
                            ?>
                        </div>
                        <?php echo $content ?>
